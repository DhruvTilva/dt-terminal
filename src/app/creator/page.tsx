...
export default function CreatorPage() {
  ...
  return (
    <div className="min-h-screen bg-bg-primary overflow-x-hidden" style={{ fontFamily: 'var(--font-sans)' }}>
      <Header />
      ...
      <main className="w-full px-4 py-10 md:py-14">
        <div className="w-full max-w-2xl mx-auto space-y-6 md:space-y-8">
          ...
          <div>
            ...
            <h1 style={{ fontSize: 24, fontWeight: 700, color: '#E6EDF3', letterSpacing: '-0.4px', lineHeight: 1.25 }}>
              Meet the Creator
            </h1>
          </div>
          ...
          <div
            ...
            style={{ background: '#121A2B', border: '1px solid #263042' }}
          >
            <div
              className="flex items-center justify-center shrink-0 rounded-full font-black"
              style={{ width: 56, height: 56, fontSize: 22, background: 'linear-gradient(135deg, #1E3A5F 0%, #1E2E4A 100%)', border: '2px solid #263042', color: '#3B82F6' }}
            >
              D
            </div>
            <div className="min-w-0 flex-1">
              <p style={{ fontSize: 16, fontWeight: 700, color: '#E6EDF3', letterSpacing: '-0.2px' }}>Dhruv Tilva</p>
              <p style={{ fontSize: 11, color: '#6B7A90', fontFamily: 'var(--font-mono)', marginTop: 2 }}>DT · Founder, DT&apos;s Terminal</p>
              <p style={{ fontSize: 13, color: '#9FB0C0', marginTop: 5, lineHeight: 1.55, overflowWrap: 'break-word' }}>
          ...
          >
            ...
            <p style={{ fontSize: 14, color: '#9FB0C0', lineHeight: 1.75, overflowWrap: 'break-word' }}>
              DT&apos;s Terminal is built to help traders find the right information at the right time.
            </p>
            <p style={{ fontSize: 14, color: '#9FB0C0', lineHeight: 1.75, marginTop: 10, overflowWrap: 'break-word' }}>
          ...
          >
            ...
            <Link
              ...
              style={{ border: '1px solid #263042', color: '#E6EDF3', fontSize: 13, fontWeight: 500 }}
            >
          ...
          <div
            ...
            style={{ background: '#121A2B', border: '1px solid #263042' }}
          >
            <p className="section-label mb-1">SUPPORT THE PROJECT</p>
            <p style={{ fontSize: 12, color: '#6B7A90', marginBottom: 16, lineHeight: 1.6 }}>
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg transition-opacity hover:opacity-85 w-full sm:w-auto justify-center sm:justify-start"
              style={{ background: 'rgba(59,130,246,0.08)', border: '1px solid rgba(59,130,246,0.2)', color: '#3B82F6', fontSize: 13, fontWeight: 600 }}
            >
            ...
            <div className="flex items-center gap-3 my-5">
              <div className="flex-1 h-px" style={{ background: '#1E2E4A' }} />
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <div className="flex justify-center items-center">
                <div
                  ...
                  style={{ background: '#fff', padding: 10, border: '1px solid #263042', boxShadow: '0 4px 20px rgba(0,0,0,0.25)' }}
                >
                  <Image
                    src="/qr-upi.png"
                    alt="UPI QR Code"
              ...
              <button
                onClick={copyUPI}
                className="flex items-center gap-2 px-4 py-2 rounded-lg transition-colors hover:bg-bg-hover"
                style={{ background: '#0F1828', border: '1px solid #263042' }}
              >
